...
void ConvolutionStack::setConvolutionBias(float * data, size_t layerIdx, size_t num_params)
{
    layers[layerIdx].setConvolutionBias(data, num_params);
}

void ConvolutionStack::setOutputWeight(float * data, size_t layerIdx, size_t num_params)
{
    layers[layerIdx].setOutputWeight(data, num_params);
}

void ConvolutionStack::setOutputBias(float * data, size_t layerIdx, size_t num_params)
{
