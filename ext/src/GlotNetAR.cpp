...
void GlotNetAR::process(const float * input_data, float * const output_data, int total_samples)
{
    this->prepare();
...
void GlotNetAR::processConditional(const float * input_data, const float *conditioning,
